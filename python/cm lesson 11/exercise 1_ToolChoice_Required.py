...
messages = [
    ...
    {"role": "user", "content": "What is the population and weather like in London?"}, #Adding "/no_think" removes thinking output but suboptimal reasoning (e.g. on 1 of 2 when asking for popl & weather)
]
...
if choice.finish_reason == "tool_calls":
    ...
    # print(f"system message after 1st pass:{messages[0]['content']}")
    # print(f"user message after 1st pass:{messages[1]['content']}")
    ...
    # print(f"system message after 2nd pass:{messages[0]['content']}")
    # print(f"user message after 2nd pass:{messages[1]['content']}")
