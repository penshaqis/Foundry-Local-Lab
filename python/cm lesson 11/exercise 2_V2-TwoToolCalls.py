...
messages = [
    ...
    {"role": "user", "content": "Who is our main client in London and how is the weather?"}, #Adding "/no_think" removes thinking output but suboptimal reasoning (e.g. only 1 of 2 when asking for popl & weather)
]
