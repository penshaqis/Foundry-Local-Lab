...
messages = [
    ...
    {"role": "user", "content": "What is the population and weather like in London?"}, #Adding "/no_think" removes thinking output but suboptimal reasoning (e.g. only 1 of 2 when asking for popl & weather)
]
