...
TOPIC = "Effective remedies for keeping stray cats from climbing fence to enter an urban condo's garden terrace. Strays have been observed using tenant's outdoor storage box to enter and exit from the fence, then shelter on patio furniture covered by patio furniture cover"
